    ...
    renderProducts(products) {
        ...
        products.forEach(product => {
            ...
            if (Array.isArray(product.images) && product.images.length > 0) {
                ...
                img.src = 'https://dummyimage.com/400x300/dee2e6/6c757d.jpg'; // Fallback image
            }
            if (img.src === 'https://example.com/image.jpg')
                img.src = 'https://dummyimage.com/400x300/dee2e6/6c757d.jpg';
            img.alt = 'No image';
            ...
            const brandH6 = document.createElement('h6');
            brandH6.className = 'fw-normal';
            brandH6.textContent = `Brand: ${product.brand}`;

            const priceP = document.createElement('p');
            priceP.textContent = `Price: $${product.price}`;

            textCenterDiv.appendChild(h5);
            textCenterDiv.appendChild(brandH6);
